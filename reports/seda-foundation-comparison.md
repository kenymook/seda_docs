...
- `accessibility.md`, `spacing-sizing.md`, `validation-model.md`, `component-anatomy.md` слишком короткие по сравнению с глубиной component specs.
...
SEDA сейчас:
- `spacing-sizing.md` содержит шкалу 4, 8, 12, 16, 24, 32 и общие правила.
...
Что улучшить:
1. Расширить `foundation/spacing-sizing.md` до spacing, grid, density, layout patterns.
...
2. Расширить `foundation/spacing-sizing.md`: spacing rules, density, grid, responsive.

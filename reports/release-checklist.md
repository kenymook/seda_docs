...
| Code mapping | Code Connect or equivalent component mapping | Priority plan, Wave 1 mapping review, canonical package decision, verified Wave 1 scaffold, and Badge/Tag/Alert/Toast/FileUpload Wave 2 exports done; Figma Code Connect blocked by Developer seat / Organization or Enterprise access |
...
- Code: `packages/seda-ui` Wave 1 scaffold exists for Button, IconButton, Link, TextField, Select, Checkbox, Radio, and Toggle; Wave 2 now includes Badge, Tag, Alert, Toast, and FileUpload exports.

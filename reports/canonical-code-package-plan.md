...
| `Toast` | `packages/seda-ui/src/components/Toast/Toast.tsx` | `6652:62` | 2 | Temporary non-blocking feedback notification. |
| `FileUpload` | `packages/seda-ui/src/components/FileUpload/FileUpload.tsx` | `6661:46` | 2 | File selection and dropzone primitive. |
...
- [x] Wave 1 components have stable exports from `packages/seda-ui/src/index.ts`; Badge, Tag, Alert, Toast, and FileUpload Wave 2 exports are also available.

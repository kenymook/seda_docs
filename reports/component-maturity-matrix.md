...
| Code mapping | Specs include code mapping sections; registry, Code Connect plan, Wave 1 mapping review, verified Wave 1 `packages/seda-ui` scaffold, and Wave 2 Badge/Tag/Alert exports exist. Real Code Connect mappings are blocked by Figma access. | Medium |
...
| Code Connect missing | System-wide | Priority plan, mapping review, verified `packages/seda-ui` Wave 1 scaffold, and Badge/Tag/Alert Wave 2 exports exist; Figma-side mapping is blocked by account access. |
...
| Add Code Connect mappings | Priority components first | Planned in `reports/code-connect-plan.md`; canonical package, Wave 1 review, and Wave 2 Badge/Tag/Alert source exports are ready, but real mappings are blocked by Figma Code Connect access. |
...
1. Add the next Wave 2 source export, recommended `Toast` or `FileUpload`.

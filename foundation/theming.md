...
SEDA UI использует CSS-переменные как основу системы тем. Вместо жёстко заданных цветов все компоненты обращаются к семантическим токенам — переменным с осмысленными именами: `surface/base`, `text/primary`, `border/hover`.
...
Примеры: `surface/base`, `border/brand/hover`, `status/danger/text`, `text/on-inverse/secondary`.
...
|---|---|---|---|
| `surface/base` | Основной фон страницы | color/neutral/0 | color/neutral/85 |
| `surface/subtle` | Фон при наведении | color/neutral/5 | color/neutral/90 |
| `surface/sunken` | Фон при нажатии | color/neutral/10 | color/neutral/95 |
| `surface/inverse` | Инверсный фон | color/neutral/85 | color/neutral/0 |
| `surface/inverse` | Инверсный фон при наведении | color/neutral/90 | color/neutral/5 |
| `surface/inverse` | Инверсный фон при нажатии | color/neutral/95 | color/neutral/5 |
| `container/brand/default` | Фирменный фон | color/blue/50 | color/blue/50 |
| `container/brand/hover` | Фирменный фон при наведении | color/blue/60 | color/blue/60 |
| `container/brand/pressed` | Фирменный фон при нажатии | color/blue/70 | color/blue/70 |
...
| Token | Role | Light | Dark |
|---|---|---|---|
| `container/neutral/default` | Контейнер по умолчанию | color/black/5 | color/white/10 |
| `container/neutral/hover` | Контейнер при наведении | color/black/10 | color/white/10 |
| `container/neutral/pressed` | Контейнер при нажатии | color/black/15 | color/white/15 |
...
| `border/strong` | Граница при нажатии | color/black/15 | color/white/15 |
...
| `border/inverse` | Инверсная граница | color/neutral/85 | color/neutral/10 |
| `border/inverse` | Инверсная граница при наведении | color/neutral/70 | color/neutral/20 |
| `border/inverse` | Инверсная граница при нажатии | color/neutral/60 | color/neutral/30 |
| `border/danger/subtle` | Ошибка: светлая граница | color/red/20 | color/neutral/80 |
| `border/danger/default` | Ошибка: средняя граница | color/red/30 | color/neutral/70 |
| `border/danger/pressed` | Ошибка: акцентная граница | color/red/40 | color/neutral/60 |
...
| `text/on-brand/tertiary` | Приглушённый текст на фирменном фоне | color/white/40 | color/white/40 |
...
| `text/on-inverse/tertiary` | Приглушённый текст на инверсном фоне | color/white/40 | color/neutral/40 |
...
| `status/danger/surface` | Ошибка: поверхность | color/red/50 | color/red/40 |
| `status/danger/container` | Ошибка: контейнер | color/red/10 | color/red/80 |
| `status/danger/border` | Ошибка: граница | color/red/50 | color/red/40 |
| `status/danger/text` | Ошибка: текст | text/on-brand/primary | text/on-brand/primary |
...
| Token | Role | Light | Dark |
|---|---|---|---|
| `shadow/ambient` | Базовая тень | color/black/5 | color/black/95 |
| `shadow/overlay` | Усиленная тень | color/black/15 | color/black/95 |
...
|---|---|
| `default` | `surface/base`, `container/neutral/default`, `border/default`, `text/primary` |
| `hover` | `surface/subtle`, `container/neutral/hover`, `border/hover` |
| `active` | `surface/sunken`, `container/neutral/pressed`, `border/strong` |
| `focus` | `focus/ring` |
| `selected` | `container/brand/default`, `container/brand/default`, `text/on-brand/primary` |
| `checked` | `container/brand/default`, `text/on-brand/primary` |
| `error` | `status/danger/border`, `status/danger/text`, `status/danger/surface` |

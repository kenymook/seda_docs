...
Компонент следует `foundation/sizes.md`, `foundation/typography.md`, `foundation/radius-border.md` и, если использует иконки, `foundation/iconography.md`.
...
[ ] Все размеры из sizes.md проверены или исключения обоснованы

...
Checkbox — контрол выбора одного независимого бинарного параметра. В SEDA AI этот компонент описывается как часть AI-ready design system framework: спецификация фиксирует назначение, variants, states, props, token mapping, accessibility, handoff и правила использования AI.
...
Используйте Checkbox, когда пользователь включает или выключает независимую настройку, подтверждает согласие или выбирает несколько пунктов в группе.

### Когда не использовать

Не используйте Checkbox, для взаимоисключающего выбора используйте Radio; для мгновенного системного режима используйте Toggle; не скрывайте label только в Tooltip.
...
Figma component set: `checkbox`. Variants: 16.
...
| --- | --- | --- |
| `$collections/components/$modes/Mode 1/checkbox/surface/default` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/checkbox/surface/checked` | Component token | `container/brand/default` |
| `$collections/components/$modes/Mode 1/checkbox/icon/default` | Component token | `text/on-brand/primary` |
| `$collections/components/$modes/Mode 1/checkbox/label/default` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/checkbox/label/disabled` | Component token | `status/disabled/text` |
| `$collections/components/$modes/Mode 1/checkbox/helper/default` | Component token | `text/tertiary` |
| `$collections/components/$modes/Mode 1/checkbox/helper/error` | Component token | `status/danger/text` |
| `$collections/components/$modes/Mode 1/checkbox/focus/ring` | Component token | `focus/ring` |
| `$collections/components/$modes/Mode 1/checkbox/disabled/surface` | Component token | `status/disabled/container` |
| `$collections/components/$modes/Mode 1/checkbox/disabled/border` | Component token | `status/disabled/border` |
| `$collections/components/$modes/Mode 1/checkbox/control/surface/default` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/checkbox/control/surface/hover` | Component token | `container/neutral/hover` |
| `$collections/components/$modes/Mode 1/checkbox/control/surface/active` | Component token | `container/neutral/pressed` |
| `$collections/components/$modes/Mode 1/checkbox/control/surface/checked` | Component token | `container/brand/default` |
| `$collections/components/$modes/Mode 1/checkbox/control/surface/indeterminate` | Component token | `container/brand/default` |
| `$collections/components/$modes/Mode 1/checkbox/control/surface/error` | Component token | `status/danger/container` |
| `$collections/components/$modes/Mode 1/checkbox/control/surface/disabled` | Component token | `status/disabled/container` |
| `$collections/components/$modes/Mode 1/checkbox/control/border/default` | Component token | `border/default` |
| `$collections/components/$modes/Mode 1/checkbox/control/border/hover` | Component token | `border/hover` |
| `$collections/components/$modes/Mode 1/checkbox/control/border/checked` | Component token | `border/brand/default` |
| `$collections/components/$modes/Mode 1/checkbox/control/border/error` | Component token | `status/danger/border` |
| `$collections/components/$modes/Mode 1/checkbox/control/border/disabled` | Component token | `status/disabled/border` |
| `$collections/components/$modes/Mode 1/checkbox/control/icon/checked` | Component token | `text/on-brand/primary` |
| `$collections/components/$modes/Mode 1/checkbox/control/icon/indeterminate` | Component token | `text/on-brand/primary` |
| `$collections/components/$modes/Mode 1/checkbox/control/icon/disabled` | Component token | `status/disabled/icon` |
...
- Figma component и node id: `1090:16624`;

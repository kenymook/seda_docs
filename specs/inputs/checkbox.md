...
| `error` | Ошибка валидации | Граница `status/error/border` |
...
|---|---|---|---|
| `--checkbox-bg` | Фон unchecked | `surface/default` | `surface/default` |
| `--checkbox-bg-hover` | Фон hover | `container/default` | `container/default` |
| `--checkbox-bg-checked` | Фон checked | `container/brand/default` | `container/brand/default` |
| `--checkbox-border` | Граница unchecked | `border/inverse/default` | `border/inverse/default` |
| `--checkbox-border-hover` | Граница hover | `border/inverse/hover` | `border/inverse/hover` |
| `--checkbox-border-error` | Граница error | `status/error/border` | `status/error/border` |

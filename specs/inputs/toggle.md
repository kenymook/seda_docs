...
Toggle — контрол мгновенного включения или выключения режима. В SEDA AI этот компонент описывается как часть AI-ready design system framework: спецификация фиксирует назначение, variants, states, props, token mapping, accessibility, handoff и правила использования AI.
...
Используйте Toggle, когда изменение применяется сразу, параметр бинарный и не требует submit.

### Когда не использовать

Не используйте Toggle, для выбора перед submit используйте Checkbox; для взаимоисключающих вариантов используйте Radio; не используйте Toggle для destructive action.
...
Figma component set: `Toggle`. Variants: 16.
...
| --- | --- | --- |
| `$collections/components/$modes/Mode 1/toggle/track/off/default` | Component token | `container/neutral/default` |
| `$collections/components/$modes/Mode 1/toggle/track/off/hover` | Component token | `container/neutral/hover` |
| `$collections/components/$modes/Mode 1/toggle/track/off/active` | Component token | `container/neutral/pressed` |
| `$collections/components/$modes/Mode 1/toggle/track/on/default` | Component token | `container/brand/default` |
| `$collections/components/$modes/Mode 1/toggle/track/on/hover` | Component token | `container/brand/hover` |
| `$collections/components/$modes/Mode 1/toggle/track/on/active` | Component token | `container/brand/pressed` |
| `$collections/components/$modes/Mode 1/toggle/track/disabled` | Component token | `status/disabled/container` |
| `$collections/components/$modes/Mode 1/toggle/thumb/default` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/toggle/thumb/disabled` | Component token | `status/disabled/container` |
| `$collections/components/$modes/Mode 1/toggle/label/default` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/toggle/label/disabled` | Component token | `status/disabled/text` |
| `$collections/components/$modes/Mode 1/toggle/helper/default` | Component token | `text/tertiary` |
| `$collections/components/$modes/Mode 1/toggle/helper/disabled` | Component token | `status/disabled/text` |
| `$collections/components/$modes/Mode 1/toggle/focus/ring` | Component token | `focus/ring` |
...
- Figma component и node id: `912:8761`;

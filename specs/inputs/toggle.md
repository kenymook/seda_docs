...
|---|---|---|
| `off-default` | Выключен | Track `container/default`, thumb белый |
| `off-hover` | Выключен, курсор над | Track `container/hover` |
...
|---|---|---|---|
| `--toggle-track-off` | Track выключен | `container/default` | `container/default` |
| `--toggle-track-off-hover` | Track hover выключен | `container/hover` | `container/hover` |
...
| `--toggle-thumb` | Цвет ползунка | `surface/default` | `surface/default` |

...
|---|---|---|---|
| `--slider-track-empty` | Незаполненная дорожка | `container/neutral/default` | `container/neutral/default` |
| `--slider-track-fill` | Заполненная дорожка | `container/brand/default` | `container/brand/default` |
| `--slider-thumb` | Цвет ползунка | `container/brand/default` | `container/brand/default` |
...
- [Text Field](../specs/inputs/text-field.md) — точный числовой ввод рядом со Slider.
- [Form](../specs/overlays-layout/form.md) — размещение Slider в формах.
- [Progress Bar](../specs/feedback/progress-bar.md) — отображение прогресса без ручного управления.

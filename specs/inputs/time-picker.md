...
Time Picker — контрол выбора времени через ввод, список или комбинированный сценарий. В SEDA AI этот компонент описывается как часть AI-ready design system framework: спецификация фиксирует назначение, variants, states, props, token mapping, accessibility, handoff и правила использования AI.
...
Используйте Time Picker, когда нужно выбрать время в заданном формате и описать ограничения, timezone rules, open, filled, error и disabled states.

### Когда не использовать

Не используйте Time Picker, для даты используйте Date Picker; для таймера или прогресса используйте Progress Bar или Spinner; не смешивайте timezone rules без handoff.
...
Figma component set: `TimePicker`. Variants: 84.
...
| --- | --- | --- |
| `$collections/components/$modes/Mode 1/time-picker/surface/default` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/time-picker/surface/hover` | Component token | `surface/subtle` |
| `$collections/components/$modes/Mode 1/time-picker/surface/active` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/time-picker/surface/focus` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/time-picker/surface/disabled` | Component token | `status/disabled/container` |
| `$collections/components/$modes/Mode 1/time-picker/surface/read-only` | Component token | `surface/subtle` |
| `$collections/components/$modes/Mode 1/time-picker/surface/loading` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/time-picker/surface/error` | Component token | `status/danger/container` |
| `$collections/components/$modes/Mode 1/time-picker/surface/warning` | Component token | `status/warning/container` |
| `$collections/components/$modes/Mode 1/time-picker/surface/success` | Component token | `status/success/container` |
| `$collections/components/$modes/Mode 1/time-picker/border/default` | Component token | `border/default` |
| `$collections/components/$modes/Mode 1/time-picker/border/hover` | Component token | `border/hover` |
| `$collections/components/$modes/Mode 1/time-picker/border/active` | Component token | `border/strong` |
| `$collections/components/$modes/Mode 1/time-picker/border/focus` | Component token | `border/focus` |
| `$collections/components/$modes/Mode 1/time-picker/border/disabled` | Component token | `status/disabled/border` |
| `$collections/components/$modes/Mode 1/time-picker/border/read-only` | Component token | `border/subtle` |
| `$collections/components/$modes/Mode 1/time-picker/border/loading` | Component token | `border/default` |
| `$collections/components/$modes/Mode 1/time-picker/border/error` | Component token | `status/danger/border` |
| `$collections/components/$modes/Mode 1/time-picker/border/warning` | Component token | `status/warning/border` |
| `$collections/components/$modes/Mode 1/time-picker/border/success` | Component token | `status/success/border` |
| `$collections/components/$modes/Mode 1/time-picker/foreground/default` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/time-picker/foreground/placeholder` | Component token | `text/muted` |
| `$collections/components/$modes/Mode 1/time-picker/foreground/disabled` | Component token | `status/disabled/text` |
| `$collections/components/$modes/Mode 1/time-picker/foreground/read-only` | Component token | `text/secondary` |
| `$collections/components/$modes/Mode 1/time-picker/label/default` | Component token | `text/secondary` |
| `$collections/components/$modes/Mode 1/time-picker/label/disabled` | Component token | `status/disabled/text` |
| `$collections/components/$modes/Mode 1/time-picker/label/read-only` | Component token | `text/secondary` |
| `$collections/components/$modes/Mode 1/time-picker/helper/default` | Component token | `text/tertiary` |
...
- Figma component и node id: `4103:4312`;

...
| `--alert-error-bg` | Фон error | `status/danger/container` | `status/danger/container` |
| `--alert-error-border` | Граница error | `status/danger/border` | `status/danger/border` |
| `--alert-error-icon` | Иконка error | `status/danger/text` | `status/danger/text` |
...
- [Toast](../specs/feedback/toast.md) — временное уведомление.
- [Form](../specs/overlays-layout/form.md) — inline validation и ошибки формы.
- [Button](../specs/actions/button.md) — действия внутри Alert.

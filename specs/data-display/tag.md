...
|---|---|---|---|
| `--tag-gray-bg` | Фон gray | `container/neutral/default` | `container/neutral/default` |
...
| Component token | Роль | Semantic (Light) | Semantic (Dark) |
|---|---|---|---|
| `--tag-selectable-bg` | Фон default | `container/neutral/default` | `container/neutral/default` |
| `--tag-selectable-bg-hover` | Фон hover | `container/neutral/hover` | `container/neutral/hover` |
...
- [Badge](../specs/data-display/badge.md) — count/status marker.
- [Chip](../specs/data-display/chip.md) — selectable или interactive label.
- [Table](../specs/data-display/table.md) — status values в строках.

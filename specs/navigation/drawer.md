...
Drawer — боковая или нижняя overlay-панель для дополнительного контента или задачи. В SEDA AI этот компонент описывается как часть AI-ready design system framework: спецификация фиксирует назначение, variants, states, props, token mapping, accessibility, handoff и правила использования AI.
...
Используйте Drawer, когда нужен контекстный panel без полной смены страницы, а задача длиннее Popover, но не требует blocking Modal.

### Когда не использовать

Не используйте Drawer, для критичного решения используйте Modal; для постоянной навигации используйте Sidebar; не вкладывайте Drawer в Drawer.
...
Figma component set: `Drawer`. Variants: 12.

| Property | Default | Options |
| --- | --- | --- |
| `placement` | `right` | `right`, `left`, `bottom` |
| `size` | `s` | `l`, `m`, `s`, `xl` |
...
| --- | --- | --- |
| `$collections/components/$modes/Mode 1/drawer/surface/default` | Component token | `surface/overlay` |
| `$collections/components/$modes/Mode 1/drawer/border/default` | Component token | `border/default` |
| `$collections/components/$modes/Mode 1/drawer/scrim/default` | Component token | `surface/scrim` |
| `$collections/components/$modes/Mode 1/drawer/title/foreground` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/drawer/description/foreground` | Component token | `text/secondary` |
| `$collections/components/$modes/Mode 1/drawer/close/icon/default` | Component token | `icon/tertiary` |
| `$collections/components/$modes/Mode 1/drawer/close/icon/hover` | Component token | `icon/primary` |
| `$collections/components/$modes/Mode 1/drawer/close/surface/hover` | Component token | `container/neutral/hover` |
| `$collections/components/$modes/Mode 1/drawer/close/surface/active` | Component token | `container/neutral/pressed` |
| `$collections/components/$modes/Mode 1/drawer/focus/ring` | Component token | `focus/ring` |
...
- Figma component и node id: `6657:116`;

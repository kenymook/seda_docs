...
Dropdown Menu — раскрывающееся меню команд или действий. В SEDA AI этот компонент описывается как часть AI-ready design system framework: спецификация фиксирует назначение, variants, states, props, token mapping, accessibility, handoff и правила использования AI.
...
Используйте Dropdown Menu, когда есть список действий, icons, shortcuts, grouped или danger items, а trigger управляет open state.

### Когда не использовать

Не используйте Dropdown Menu, для формы используйте Popover или Modal; для выбора значения используйте Select; не используйте для длинного контента.
...
| --- | --- | --- |
| `$collections/components/$modes/Mode 1/dropdown-menu/surface/default` | Component token | `surface/overlay` |
| `$collections/components/$modes/Mode 1/dropdown-menu/border/default` | Component token | `border/default` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/foreground/default` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/foreground/disabled` | Component token | `status/disabled/text` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/foreground/secondary` | Component token | `text/secondary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/foreground/selected` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/surface/hover` | Component token | `container/neutral/hover` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/surface/active` | Component token | `container/neutral/pressed` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/surface/default` | Component token | `color/transparent` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/surface/selected` | Component token | `container/neutral/selected` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/surface/disabled` | Component token | `color/transparent` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/icon/default` | Component token | `icon/tertiary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/icon/selected` | Component token | `icon/primary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/icon/disabled` | Component token | `status/disabled/icon` |
| `$collections/components/$modes/Mode 1/dropdown-menu/item/description/foreground` | Component token | `text/tertiary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/group-title/foreground` | Component token | `text/tertiary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/separator/default` | Component token | `border/subtle` |
| `$collections/components/$modes/Mode 1/dropdown-menu/checkmark/default` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/checkmark/selected` | Component token | `icon/primary` |
| `$collections/components/$modes/Mode 1/dropdown-menu/groupTitle/foreground` | Component token | `text/tertiary` |

...
Container — layout-обертка для ограничения ширины, padding и responsive behavior. В SEDA AI этот компонент описывается как часть AI-ready design system framework: спецификация фиксирует назначение, variants, states, props, token mapping, accessibility, handoff и правила использования AI.
...
Используйте Container, когда нужно стабилизировать ширину контента, отступы и responsive composition.

### Когда не использовать

Не используйте Container, не используйте как декоративную карточку; не задавайте one-off spacing без token rule; не вкладывайте контейнеры без причины.
...
Figma component set: `Container`. Variants: 48.
...
| --- | --- | --- |
| `$collections/components/$modes/Mode 1/container/surface/page` | Component token | `surface/page` |
| `$collections/components/$modes/Mode 1/container/surface/base` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/container/surface/subtle` | Component token | `surface/subtle` |
| `$collections/components/$modes/Mode 1/container/surface/raised` | Component token | `surface/raised` |
| `$collections/components/$modes/Mode 1/container/surface/overlay` | Component token | `surface/overlay` |
| `$collections/components/$modes/Mode 1/container/surface/inverse` | Component token | `surface/inverse` |
| `$collections/components/$modes/Mode 1/container/border/default` | Component token | `border/default` |
| `$collections/components/$modes/Mode 1/container/border/subtle` | Component token | `border/subtle` |
| `$collections/components/$modes/Mode 1/container/border/strong` | Component token | `border/strong` |
| `$collections/components/$modes/Mode 1/container/divider/default` | Component token | `border/subtle` |
| `$collections/components/$modes/Mode 1/container/scrim/default` | Component token | `surface/scrim` |
| `$collections/semantic/$modes/Light/container/neutral/default` | Component token | `color/black/5` |
| `$collections/semantic/$modes/Light/container/neutral/hover` | Component token | `color/black/10` |
| `$collections/semantic/$modes/Light/container/neutral/pressed` | Component token | `color/black/15` |
| `$collections/semantic/$modes/Light/container/neutral/selected` | Component token | `color/black/20` |
| `$collections/semantic/$modes/Light/container/subtle/default` | Component token | `color/neutral/5` |
| `$collections/semantic/$modes/Light/container/subtle/hover` | Component token | `color/neutral/10` |
| `$collections/semantic/$modes/Light/container/subtle/pressed` | Component token | `color/neutral/15` |
| `$collections/semantic/$modes/Light/container/subtle/selected` | Component token | `color/neutral/20` |
| `$collections/semantic/$modes/Light/container/brand/default` | Component token | `color/blue/50` |
| `$collections/semantic/$modes/Light/container/brand/hover` | Component token | `color/blue/60` |
| `$collections/semantic/$modes/Light/container/brand/pressed` | Component token | `color/blue/70` |
| `$collections/semantic/$modes/Light/container/brand/selected` | Component token | `color/blue/15` |
| `$collections/semantic/$modes/Light/container/accent/default` | Component token | `color/purple/50` |
| `$collections/semantic/$modes/Light/container/accent/hover` | Component token | `color/purple/60` |
| `$collections/semantic/$modes/Light/container/accent/pressed` | Component token | `color/purple/70` |
| `$collections/semantic/$modes/Light/container/accent/selected` | Component token | `color/purple/10` |
| `$collections/semantic/$modes/Light/container/info/default` | Component token | `color/blue/50` |
...
- Figma component и node id: `1353:6860`;

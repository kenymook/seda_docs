...
Notification Center — центр просмотра системных и продуктовых уведомлений. В SEDA AI этот компонент описывается как часть AI-ready design system framework: спецификация фиксирует назначение, variants, states, props, token mapping, accessibility, handoff и правила использования AI.
...
Используйте Notification Center, когда нужно хранить историю событий, unread states, loading/error и фильтрацию уведомлений.

### Когда не использовать

Не используйте Notification Center, не используйте вместо Toast для мгновенного feedback; не используйте как blocking Modal; не смешивайте с Timeline без правил.
...
Figma component set: `Notification Center`. Variants: 40.

| Property | Default | Options |
| --- | --- | --- |
| `placement` | `panel` | `panel`, `overlay` |
| `state` | `empty` | `empty`, `has-unread`, `all-read`, `loading`, `error` |
| `size` | `s` | `s`, `m`, `l`, `xl` |
...
| --- | --- | --- |
| `$collections/components/$modes/Mode 1/notification-center/surface/default` | Component token | `surface/overlay` |
| `$collections/components/$modes/Mode 1/notification-center/item/surface/unread` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/notification-center/item/surface/read` | Component token | `surface/base` |
| `$collections/components/$modes/Mode 1/notification-center/item/surface/hover` | Component token | `container/neutral/hover` |
| `$collections/components/$modes/Mode 1/notification-center/item/surface/active` | Component token | `container/neutral/pressed` |
| `$collections/components/$modes/Mode 1/notification-center/item/surface/selected` | Component token | `container/neutral/selected` |
| `$collections/components/$modes/Mode 1/notification-center/item/border/default` | Component token | `border/subtle` |
| `$collections/components/$modes/Mode 1/notification-center/item/foreground/unread` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/notification-center/item/foreground/read` | Component token | `text/secondary` |
| `$collections/components/$modes/Mode 1/notification-center/item/foreground/disabled` | Component token | `status/disabled/text` |
| `$collections/components/$modes/Mode 1/notification-center/item/timestamp/foreground` | Component token | `text/tertiary` |
| `$collections/components/$modes/Mode 1/notification-center/item/icon/unread` | Component token | `icon/brand` |
| `$collections/components/$modes/Mode 1/notification-center/item/icon/read` | Component token | `icon/tertiary` |
| `$collections/components/$modes/Mode 1/notification-center/header/foreground` | Component token | `text/primary` |
| `$collections/components/$modes/Mode 1/notification-center/header/border` | Component token | `border/default` |
| `$collections/components/$modes/Mode 1/notification-center/empty/foreground` | Component token | `text/secondary` |
| `$collections/components/$modes/Mode 1/notification-center/shadow` | Component token | `shadow/overlay` |
...
- Figma component и node id: `6977:2860`;
